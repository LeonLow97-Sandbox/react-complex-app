...
function HomeGuest() {
  ...
  // to handle a new sign up
  // have to include "async" to use "await"
  async function handleSubmit(e) {
    e.preventDefault();
    // send network request to the backend server via POST request method
    try {
      // the request is an asynchronous function, don't want to show
      //  this console.log message until the POST request (sign up) has been completed
      await Axios.post("/register", { username, email, password });
      console.log("User was successfully created.");
    } catch (e) {
      // "e" for Microsoft Edge, they require it
